...
#define AI_NETWORK_MODEL_SIGNATURE     "afab06c9e97a5859bd4f17e4b26ab6ab"
...
AI_STATIC ai_array conv2_bias_array;   /* Array #4 */
AI_STATIC ai_array conv2_weights_array;   /* Array #5 */
AI_STATIC ai_array conv1_bias_array;   /* Array #6 */
AI_STATIC ai_array conv1_weights_array;   /* Array #7 */
AI_STATIC ai_array input_0_output_array;   /* Array #8 */
AI_STATIC ai_array conv1_output_array;   /* Array #9 */
AI_STATIC ai_array conv2_output_array;   /* Array #10 */
...
AI_STATIC ai_tensor conv2_bias;   /* Tensor #4 */
AI_STATIC ai_tensor conv2_weights;   /* Tensor #5 */
AI_STATIC ai_tensor conv1_bias;   /* Tensor #6 */
AI_STATIC ai_tensor conv1_weights;   /* Tensor #7 */
AI_STATIC ai_tensor input_0_output;   /* Tensor #8 */
AI_STATIC ai_tensor conv1_output;   /* Tensor #9 */
AI_STATIC ai_tensor conv2_output;   /* Tensor #10 */
AI_STATIC ai_tensor conv2_output0;   /* Tensor #11 */
